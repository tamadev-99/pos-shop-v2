...
export default function ProdukClient({ initialProducts, categories }: ProdukClientProps) {
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 animate-fade-up">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-1">
            Kelola katalog produk fashion Anda
          </p>
        </div>
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-white/[0.06] to-white/[0.02] flex items-center justify-center shrink-0 border border-white/[0.04] shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]">
              ...
              <div className="flex flex-wrap gap-1.5">
                ...
                {getUniqueColors(selectedProduct).map((color) => (
                  <span
                    key={color}
                    className="inline-block px-2 py-0.5 rounded-md text-[11px] font-medium bg-white/[0.05] border border-white/[0.06] text-muted-foreground"
                  >
                    {color}
                  </span>
                ))}
