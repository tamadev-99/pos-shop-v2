...
import { Banknote, CreditCard, Check, QrCode, Building2, Wallet, Printer, MessageCircle, Loader2, Monitor } from "lucide-react";
    ...
    <Dialog open={open} onClose={handleClose} className="max-w-md">
      ...
      <div className="space-y-5 mt-2">
        ...
        <Button
          ...
          disabled={(method === "tunai" && cashNum < total) || isSubmitting}
